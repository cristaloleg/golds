...
func NewBinaryHeap(comp CmpFunc) *BinaryHeap {
	h := &BinaryHeap{
		size: 0,
...
func NewBinaryHeapSized(size int, comp CmpFunc) *BinaryHeap {
	h := &BinaryHeap{
		size: 0,
...
// down pushes element down in the heap
...
// up pushes element up in the heap
